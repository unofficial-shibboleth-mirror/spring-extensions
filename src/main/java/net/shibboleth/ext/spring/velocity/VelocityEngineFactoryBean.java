 ...
 *
 * <pre class="code">
 *   &lt;bean id="velocityEngine" class="net.shibboleth.ext.spring.velocity.VelocityEngineFactoryBean"&gt;
...
public class VelocityEngineFactoryBean extends VelocityEngineFactory
    ...
    /** {@inheritDoc} */
    @Override
    @Nullable public VelocityEngine getObject() {
        return velocityEngine;
    }

    /** {@inheritDoc} */
    @Override
    @Nullable public Class<? extends VelocityEngine> getObjectType() {
