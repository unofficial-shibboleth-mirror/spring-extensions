...
package net.shibboleth.ext.spring.naturestudy;
...
public class TheBeanTest {
    ...
    @Test public void testRawNativeBean() {
        ...
        TheBean bean = getBeanNative("classpath:net/shibboleth/ext/spring/naturestudy/SimpleBean.xml");

        Assert.assertEquals(bean.getMessage(), "Spring");
    }

    @Test public void testRawReplaceBean() {
        TheBean bean = getBeanNative("classpath:net/shibboleth/ext/spring/naturestudy/SimpleBeanReplace.xml");
    ...
    @Test public void testRawCustomBean() {
        ...
        TheBean bean = getBeanNative("classpath:net/shibboleth/ext/spring/naturestudy/CustomBean.xml");
    ...
    @Test public void testReplaceCustomBean() {
        ...
        TheBean bean = getBeanNative("classpath:net/shibboleth/ext/spring/naturestudy/CustomBeanReplace.xml");
    ...
    @Test public void testRawCustomBean2() {
        ...
        TheBean bean = getBeanNative("classpath:net/shibboleth/ext/spring/naturestudy/CustomBean2.xml");
    ...
    @Test public void testReplaceCustomBean2() {
        ...
        TheBean bean = getBeanNative("classpath:net/shibboleth/ext/spring/naturestudy/CustomBeanReplace2.xml");
    ...
    @Test public void testReplaceCustomBean3() {
        ...
        beanDefinitionReader.loadBeanDefinitions(new ClassPathResource(
                "net/shibboleth/ext/spring/naturestudy/CustomBeanReplace3.xml"), new ClassPathResource(
                "net/shibboleth/ext/spring/naturestudy/PropertyPlaceholder.xml"));
        context.refresh();
    ...
    @Test public void testRemoveSecondBean() {
        ...
        beanDefinitionReader.loadBeanDefinitions(new ClassPathResource(
                "net/shibboleth/ext/spring/naturestudy/MultipleBeans.xml"));
        Assert.assertEquals(TheSecondBean.getInitCount(), 0);
